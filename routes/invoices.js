...
router.get('/invoices',function(req,res){
    if ("name" in req.query){
        ...
        db.all(`select * from invoices where customer_name="${req.query.name}" COLLATE NOCASE`,function(err,rows){
            if (err){
                console.log('a')
        ...
        db.all(`select * from invoices where invoice_id="${req.query.id}" COLLATE NOCASE`,function(err,rows){
            if (err){
                console.log('a')
                res.send(err.message)
                return console.error(err.message)
